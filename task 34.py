...
# то они разделяются дефисами. Фразы отделяются другот друга пробелами.Стихотворение
...
print ('Стих; пара-ра-рам рам-пам-папам па-ра-па-дам : \nНажмите еще раз на запуск > чтобы увидеть правильный ответ!')
str = input( )
if rhythm(str):
    print('Парам пам-пам')
else:
